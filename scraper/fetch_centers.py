...
CSV_URL = "https://data-seattlecitygis.opendata.arcgis.com/api/download/v1/items/0a0850f5dec54679b970c4dede080d6b/csv?layers=0"
BASE_DIR = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))

RAW_FILE = os.path.join(BASE_DIR, "data", "raw", "community_centers.csv")
PROCESSED_FILE = os.path.join(BASE_DIR, "data", "processed", "centers_with_websites.csv")
...
if __name__ == "__main__":
    ...
    try:
        ...
        filtered_df = create_filtered_dataset(df)
